...
const url = "https://mainnet.infura.io/v3/5c793d33ecff451592241abb6509b520";
...
const dapp = async () => {
  ...
  const holderAdress = "0xA7A93fd0a276fc1C0197a5B5623eD117786eeD06";

  const holderBalance = await tetherContract.methods
    .balanceOf(holderAdress)
    .call();
